...
[Download now](https://github.com/ws-garcia/VBA-CSV-interface/releases/latest/download/asset-name.zip){: .btn .btn-primary .fs-4 .mb-4 .mb-md-0 .mr-2 } [View it on GitHub](https://github.com/ws-garcia/VBA-CSV-interface){: .btn .fs-4 .mb-4 .mb-md-0 }
---
